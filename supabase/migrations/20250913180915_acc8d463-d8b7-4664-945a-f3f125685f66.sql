-- Drop existing types if they exist and recreate the banner system
DROP TABLE IF EXISTS public.banners CASCADE;
DROP TYPE IF EXISTS banner_type CASCADE;
DROP TYPE IF EXISTS banner_status CASCADE;
DROP FUNCTION IF EXISTS public.get_active_banner CASCADE;
DROP FUNCTION IF EXISTS public.update_banner_timestamps CASCADE;
