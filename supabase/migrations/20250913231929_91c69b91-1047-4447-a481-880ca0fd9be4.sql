...
CREATE POLICY "Rate limits admin view policy" ON public.contact_rate_limits
FOR SELECT USING (is_admin_user(auth.uid()));

-- System can manage rate limits
CREATE POLICY "Rate limits system management policy" ON public.contact_rate_limits
