...
-- Insert default banners (using gen_random_uuid() for IDs)
INSERT INTO public.banners (name, gif_url, position, category, is_active, is_default) VALUES
('Banner Principal', '/src/assets/banner-principal.jpg', 'hero', NULL, true, true),
('Banner Política', '/src/assets/banner-politica.jpg', 'category', 'Política', true, true),
('Banner Policial', '/src/assets/banner-policial.jpg', 'category', 'Policial', true, true),
('Banner Entretenimento', '/src/assets/banner-entretenimento.jpg', 'category', 'Entretenimento', true, true),
('Banner Internacional', '/src/assets/banner-internacional.jpg', 'category', 'Internacional', true, true),
('Banner Esportes', '/src/assets/banner-esportes.jpg', 'category', 'Esportes', true, true),
('Banner Tecnologia', '/src/assets/banner-tecnologia.jpg', 'category', 'Tecnologia', true, true),
('Banner Ciência / Saúde', '/src/assets/banner-ciencia-saude.jpg', 'category', 'Ciência / Saúde', true, true);